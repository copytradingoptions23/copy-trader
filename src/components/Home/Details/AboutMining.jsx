    ...
    <div className='details'>
      ...
      <div className="hero hero-bit">
        ...
        <div className="hero-content">
          <h1 className="hero-title">About Mining</h1>
        </div>
      </div>
